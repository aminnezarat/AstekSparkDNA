 ...
 */
package seq.am.yz.astekdna.serialization

/**
 * Object for setting various KryoSerializer properties.
 */
object AstekSeqKryoProperties {
  ...
  def setupKryoContextProperties() = {
    ...
    System.setProperty("spark.kryo.registrator", "seq.am.yz.astekdna.serialization.AstekSeqKryoRegistrator")
