...
import seq.am.yz.astekdna.differentialExpression.AstekSeqDiffExpr
import seq.am.yz.astekdna.differentialExpression.AstekSeqDiffExpr
...
object AstekSeqDERFinder {
  ...
  def main(args: Array[String]) {
    ...
    */
    ...
    val seqAnalysisCase = new AstekSeqAnalysis(sc, pathFam1 + "/M/orbFrontalF1" + testSuff, 25, 1, numTasks)
    ...
    val seqAnalysisControl = new AstekSeqAnalysis(sc, pathFam1 + "/F/orbFrontalF2" + testSuff, 26, 1, numTasks)
    ...
    val diffExp = new AstekSeqDiffExpr(sc, seqAnalysisCase, seqAnalysisControl,
