 ...
 */
package seq.am.yz.astekdna.permutationTests

import seq.am.yz.astekdna.statisticalTests._
import org.apache.commons.math3.util.ArithmeticUtils._
import seq.am.yz.astekdna.statisticalTests.AstekSeqStatisticalTest
 ...
 */
class AstekSeqAdaptivePermutTest(iNPermut: Int = 1000, iStatTests: Array[AstekSeqStatisticalTest], iX: Seq[Int], iY: Seq[Int]) {
