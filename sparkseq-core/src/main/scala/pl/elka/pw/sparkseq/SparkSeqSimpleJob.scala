...
object SparkSeqSimpleJob {
 ...
 def main(args: Array[String]) {
    ...
    */
    ...
    /*Test Exon counts*/
    val covCase = seqAnalysisCase.getCoverageRegion(genExonsMapB).map(c => (c._1._1 % 100000000000L, c._2)).groupByKey()
      .map(c=>(c._1,c._2 )) //.partitionBy(new HashPartitioner(15))
   val covControl = seqAnalysisControl.getCoverageRegion(genExonsMapB).map(c => (c._1._1 % 100000000000L, c._2)).groupByKey()
       .map(c=>(c._1,c._2 ))//.partitionBy(new HashPartitioner(15))
